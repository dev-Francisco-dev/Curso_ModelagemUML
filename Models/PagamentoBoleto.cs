...
namespace Models
{
    ...
    {        
        ...
        public PagamentoBoleto(int id,DateTime dataVencimento, DateTime dataPagamento, EstadoPagamento estadoPagamento, Pedido pedido, Cliente cliente, Endereco endereco) : base(id, estadoPagamento, pedido, cliente, endereco)
        {            
